...
const DEMO_AGENTS = [
  ...
  },
  {
    ...
    description: 'Traduce documentos entre idiomas manteniendo contexto tecnico y formato original.',
  ...
  },
  {
    ...
    description: 'Revisa codigo fuente buscando bugs, vulnerabilidades y oportunidades de mejora.',
  ...
  },
  {
    ...
    description: 'Genera tests unitarios y de integracion automaticamente a partir del codigo fuente.',
  ...
  },
  {
    ...
    description: 'Valida datos contra schemas JSON/XML y sugiere correcciones automaticas.',
  ...
  },
  {
    ...
    description: 'Construye reportes ejecutivos combinando datos, graficos y narrativa automatizada.',
  ...
  },
  {
    ...
    description: 'Monitorea metricas del sistema y genera alertas cuando se detectan anomalias.',
  ...
  },
  {
    ...
    description: 'Rankea y prioriza tareas, tickets o documentos segun criterios configurables.',
  ...
  },
  {
    ...
    description: 'Detecta documentos duplicados o quasi-duplicados usando hashing y similitud semantica.',
  ...
  },
  {
    ...
    description: 'Detecta patrones anomalos en datos financieros, logs y series temporales.',

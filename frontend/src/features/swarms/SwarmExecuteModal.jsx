...
const LABELS = {
  ...
  es: {
    ...
    close: 'Cerrar modal',
    configExecution: 'Selecciona agentes y configura la ejecución',
    ...
    stepsIn: 'pasos en',
    allStarting: 'Todos los agentes iniciando simultáneamente...',
    aggregating: 'Agregando resultados de',
    agentsLabel: 'agentes',
    parallelComplete: 'Ejecución paralela completa',
    ...
    hierarchicalComplete: 'Ejecución jerárquica',
    ...
    needsMoreDetail: 'necesita más detalle sobre factores de riesgo financiero',
    goodImprovement: 'buena mejora, falta contexto regulatorio',
    improving: 'Mejorando basado en retroalimentación...',
    reEvaluating: 'Re-evaluando...',
    finalRevision: 'Revisión final...',
    ...
    adaptiveSelected: 'Adaptivo seleccionó',
    select: 'Seleccionar',

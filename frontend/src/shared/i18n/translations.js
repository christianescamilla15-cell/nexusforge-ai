export const translations = {
  en: {
    ...
    tourDemo4: 'Each agent specializes in a task and uses the LLM router. Meet the 22 AI agents.',
  ...
  es: {
    ...
    tourDemo1: 'El dashboard muestra la salud de tu plataforma en tiempo real. Mira como las metricas cobran vida.',
    tourDemo2: 'Los workflows son pipelines DAG que encadenan agentes IA. Observa como se construye uno.',
    tourDemo3: 'Las ejecuciones corren en tiempo real con monitoreo WebSocket. Mira un workflow ejecutarse.',
    tourDemo4: 'Cada agente se especializa en una tarea y usa el router LLM. Conoce los 22 agentes IA.',
    tourDemo5: '6 topologias definen como colaboran los agentes. Ve el patron Debate en accion.',
    tourDemo6: 'Sube documentos — se fragmentan, vectorizan e indexan para busqueda semantica.',
    tourDemo7: 'El Asistente IA sabe todo sobre NexusForge — preguntale lo que quieras!',
    tourReady: 'Estas listo!',
    tourFinal: 'Has explorado cada seccion de NexusForge AI. Comienza a construir workflows inteligentes con agentes autonomos.',
    tourStats: '231 Tests — Docker — Terraform — Kubernetes',
    next: 'Siguiente',
    skip: 'Saltar Tour',
    finish: 'Comenzar',

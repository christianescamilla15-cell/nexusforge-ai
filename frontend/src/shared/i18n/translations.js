export const translations = {
  ...
  es: {
    ...
    detection: 'Deteccion',
    strategySelection: 'Seleccion de Estrategia',
    ...
    healingTime: 'Tiempo de reparacion',
    ...
    tourCompleteDesc: 'Has explorado cada seccion de NexusForge AI. Comienza a construir workflows inteligentes con agentes autonomos.',
    tourStepWelcome: 'Bienvenido a NexusForge AI',
    tourStepWelcomeDesc: 'Plataforma de Orquestacion de Agentes. Este tour interactivo te guiara por las funciones reales con demos en vivo.',
    ...
    tourStepWorkflowsDesc: 'Crea y gestiona pipelines de ejecucion DAG que encadenan agentes IA.',
    ...
    tourStepExecutionDetail: 'Detalle de Ejecucion',
    tourStepExecutionDetailDesc: 'Ve cada paso del pipeline con estado, duracion, tokens y costo.',
    tourStepAgents: 'Agentes IA',
    tourStepAgentsDesc: '22 agentes especializados con memoria de 3 niveles (Trabajo, Episodica, Semantica).',
    tourStepSwarms: 'Topologias de Enjambre',
    tourStepSwarmsDesc: '6 patrones de ejecucion: Secuencial, Paralelo, Jerarquico, Debate, Consenso, Adaptativo.',
    tourStepMemory: 'Sistema de Memoria',
    tourStepMemoryDesc: 'Observa como los datos fluyen por Working, Episodic y Semantic memory.',
    tourStepHealing: 'Auto-Reparacion',
    tourStepHealingDesc: 'Deteccion automatica de errores, clasificacion y recuperacion con 5 estrategias.',
    tourStepDocuments: 'Busqueda de Documentos',
    tourStepDocumentsDesc: 'Busqueda semantica con vector embeddings y pipeline RAG.',
    tourStepChat: 'Asistente IA',
    tourStepChatDesc: 'Pregunta lo que quieras sobre NexusForge — agentes, workflows, arquitectura.',
    tourStepFinal: 'Listo!',
    tourStepFinalDesc: 'Has visto cada funcion. Es hora de explorar por tu cuenta.',
    pagesVisited: 'paginas visitadas',

...
const NAV_ITEMS = [
  ...
  { key: 'workflows', label: 'Workflows', icon: 'M4 6h16M4 12h8m-8 6h16' },
  { key: 'executions', label: 'Ejecuciones', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  { key: 'agents', label: 'Agentes', icon: 'M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714a2.25 2.25 0 00.659 1.591L19 14.5M14.25 3.104c.251.023.501.05.75.082M19 14.5l-2.47 3.71a.75.75 0 01-.625.334H8.095a.75.75 0 01-.625-.334L5 14.5m14 0H5' },
  { key: 'swarms', label: 'Swarms', icon: 'M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.007v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 5.25h.007v.008H3.75v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z' },
  { key: 'documents', label: 'Documentos', icon: 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z' },
  { key: 'settings', label: 'Ajustes', icon: 'M10.343 3.94c.09-.542.56-.94 1.11-.94h1.093c.55 0 1.02.398 1.11.94l.149.894c.07.424.384.764.78.93s.844.126 1.197-.094l.758-.474a1.12 1.12 0 011.37.15l.773.773a1.12 1.12 0 01.15 1.37l-.474.758c-.22.353-.254.804-.094 1.197.16.396.506.71.93.78l.894.15c.542.09.94.56.94 1.109v1.094c0 .55-.398 1.02-.94 1.11l-.894.149c-.424.07-.764.384-.93.78s-.126.844.094 1.197l.474.758a1.12 1.12 0 01-.15 1.37l-.773.773a1.12 1.12 0 01-1.37.15l-.758-.474c-.353-.22-.804-.254-1.197-.094-.396.16-.71.506-.78.93l-.15.894c-.09.542-.56.94-1.109.94h-1.094c-.55 0-1.02-.398-1.11-.94l-.148-.894c-.071-.424-.384-.764-.781-.93s-.844-.126-1.197.094l-.757.474a1.12 1.12 0 01-1.37-.15l-.774-.773a1.12 1.12 0 01-.15-1.37l.474-.758c.22-.353.254-.804.094-1.197a2.25 2.25 0 00-.93-.78l-.894-.15c-.542-.09-.94-.56-.94-1.109v-1.094c0-.55.398-1.02.94-1.11l.894-.149c.424-.07.764-.384.93-.78s.126-.844-.094-1.197l-.474-.758a1.12 1.12 0 01.15-1.37l.773-.774a1.12 1.12 0 011.37-.15l.758.474c.353.22.804.254 1.197.094.396-.16.71-.506.78-.93l.15-.894zM15 12a3 3 0 11-6 0 3 3 0 016 0z' },
]
...
export default function Layout({ currentPage, onNavigate, children }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      {/* Sidebar */}
      <aside style={{
        width: w, minWidth: w, height: '100vh', position: 'fixed', top: 0, left: 0,
        background: '#0F1117', borderRight: '1px solid rgba(255,255,255,0.06)',
      ...
      {/* Main content */}
      <div style={{ marginLeft: w, flex: 1, transition: 'margin-left 0.2s ease' }}>
        {/* Top bar */}
        <header style={{
          height: topBarHeight, display: 'flex', alignItems: 'center',
          ...
          <div style={{ position: 'relative', maxWidth: 400, flex: 1 }}>
            ...
            <input
              type="text"
              placeholder="Buscar workflows, agentes..."
              aria-label="Buscar"
              style={{
        ...
        {/* Page content */}
        <main style={{ padding: 24, minHeight: `calc(100vh - ${topBarHeight}px)` }}>
          {children}
        </main>
      </div>
    </div>

...
Built for Aeromexico-scale enterprise systems (NYSE-listed, $13M risk exposure).
...
- Cloud LLMs: Haiku 4.5 ($1/MTok) + Groq (free) + Claude Sonnet 4.6 (paid, cached)
...
- Tested on: vuln-test (4 files), dotnet-identity (1106 files), eShop (633 files), Aeromexico (128 files), NexusForge (620 files)
...
- /api/refactor/scan-pii, /scan-db, /scan-rpa, /generate-tests
